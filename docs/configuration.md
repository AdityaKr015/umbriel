...
When dragging a column, the extreme right edge of the output targets the end of
the scrolling strip. This remains available when later columns are off-screen.
