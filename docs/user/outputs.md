...
key. See [window rules](rules-windows.md#settings-updated-while-a-window-is-open).
...
See [window rules](rules-windows.md#settings-updated-while-a-window-is-open)
