...
void Output::fixSceneOrder() {
  ...
  wlr_scene_node_place_below(
      &m_layerTrees[ZWLR_LAYER_SHELL_V1_LAYER_BACKGROUND]->node,
      &m_layerTrees[ZWLR_LAYER_SHELL_V1_LAYER_BOTTOM]->node);
...
void Output::arrangeLayer(
    wlr_scene_tree* tree, const wlr_box* fullArea, wlr_box* usableArea, bool exclusive) {
