...
readonly CONFIG_BACKUP="$UMBRIEL_CONFIG.vertical-viewport-clips.bak"
...
capture() {
  env -u DISPLAY -u DBUS_SESSION_BUS_ADDRESS \
    XDG_RUNTIME_DIR="$UMBRIEL_RUNTIME_DIR" WAYLAND_DISPLAY=wayland-0 grim "$1"
}
